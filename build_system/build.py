...
def library(
 ...
 lib_type = 'both'):
    ...
    #ignoreHeaders = ['analysis/h10maker/bcs.inc', 'analysis/nt10maker/bcs.inc','analysis/h10maker/wcs.inc', 'analysis/nt10maker/wcs.inc', 'analysis/h10maker/seb_nt.inc']
    #install_headers(env, headers, ignoreHeaders)
