...
def required_dependencies():
    return 'packlib mathlib mclibs geant321 mysql tcl gfortran'.split()  #    return 'cern mysql tcl gfortran'.split()
...
def gsim_libs(env):
    return 'gsim blas mathlib X11 Xm'.split()
...
def load_flags(env):
    ...
    env.AppendUnique(LINKFLAGS = '-Wl,-undefined,dynamic_lookup'.split())
